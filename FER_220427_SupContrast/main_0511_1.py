...
from losstest import NT_Xent,SimCLR
...
for batch_size in batch_sizes:
    for learning_rate in learning_rates:
        ...
        # loss and optimizer
        criterion = NT_Xent(batch_size=batch_size, temperature=temperature,world_size=world_size )
        ...
        for epoch in range(num_epochs):
            ...
            for step,(image,targets) in enumerate(train_loader):
                ...
                h_i,h_j,z_i,z_j = model(image,targets)
