from deformable_convolution import DeformableConv2d
import torch
...
class Modify_Resnet(nn.Module):
    def __init__(self):
        ...
        self.model.conv1 = nn.Conv2d(64, 64, kernel_size=3, stride=2, padding=3, bias=False)
...
model = Modify_Resnet()
model.load_state_dict(torch.load("./models/dcn_weights_resnet.pt"))
...
with torch.no_grad():
        image = cv2.imread("C:/Users/1315/Desktop/test/ck_val168.jpg",cv2.IMREAD_COLOR)
